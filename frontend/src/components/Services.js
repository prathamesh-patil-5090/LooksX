...
const ServiceCard = ({ title, description, icon: Icon }) => (
  <div className="group relative p-8 bg-black/30 backdrop-blur-sm rounded-2xl border border-gray-800 overflow-hidden transition-all duration-300 hover:border-[#D4B86A]/50">
